...
class ApiConfig {
  ...
  static String get adminObjectId => '699ec9b62e762d6e57b28cda'; // Will be replaced during publish
...
class AdminManager {
  ...
  static Future<String> getCurrentAdminId() async {
    ...
    if (adminId == '699ec9b62e762d6e57b28cda' || adminId.isEmpty) {
    ...
    if (ApiConfig.adminObjectId != '699ec9b62e762d6e57b28cda' && ApiConfig.adminObjectId.isNotEmpty) {
      assert(
